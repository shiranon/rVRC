		...
		? [
				{
					name: 'description',
					content:
						'VRChat用アイテムを整理・共有できるフォルダ機能ページ。お気に入りのアバターや衣装を自由にカテゴリ分け。公開設定で他のユーザーとフォルダを共有可能。みんなのおすすめアイテムをチェックできます。',
				},
				{
...
export default function Folder() {
	...
	return (
		<>
			<div className="w-full px-6 pt-12 pb-6 max-w-[640px] mx-auto">
